...
/**
 * A component for displaying the `vectors` attribute of an paymentinfo entity.
 *
 ...
 * @param {Array} [props.paymentinfo.vectors] - An array of vectors items associated with the paymentinfo entity.
 ...
 */
export const PaymentInfoVectorsAttribute = ({paymentinfo}) => {
...
query PaymentInfoQueryRead($id: id, $where: VectorInputFilter, $skip: Int, $limit: Int) {
...
export const PaymentInfoVectorsAttributeInifite = ({paymentinfo}) => { 
    const {vectors} = paymentinfo

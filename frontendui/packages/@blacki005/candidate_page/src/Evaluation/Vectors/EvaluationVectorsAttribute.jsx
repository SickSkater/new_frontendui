...
const EvaluationVectorsAttributeQuery = `
...
const EvaluationVectorsAttributeAsyncAction = createAsyncGraphQLAction(
    EvaluationVectorsAttributeQuery,
...
export const EvaluationVectorsAttributeInifite = ({evaluation}) => { 
    ...
    return (
        <InfiniteScroll 
            ...
            asyncAction={EvaluationVectorsAttributeAsyncAction}
        />
    )
}